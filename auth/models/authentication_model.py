...
from auth.models.oauth2 import GoogleModel
from auth.models.oauth2 import MicrosoftModel
from auth import params
from auth.utilities import (Hasher,
                         Helpers,
                         CredentialsError,
                         ForgotError,
                         LoginError,
...
class AuthenticationModel:
    ...
    def _get_user_variables(self, username: str) -> tuple:
        ...
        if 'roles' in self.credentials['usernames'][username]:
            ...
            roles = None
        return self.credentials['usernames'][username], name, roles
